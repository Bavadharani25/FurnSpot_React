...
import PurchaseSuccess from "./Components/User/PurchaseSuccess";
import DiningSet from './Components/User/DiningSet';
import Storage from './Components/User/Storage';
import StudyTable from './Components/User/StudyTable';
import Office from './Components/User/Office';
import Dressing from './Components/User/Dressing';
import Egchair from './Components/User/Egchair';
import Shoe from './Components/User/Shoe';
...
import PetFurniture from './Components/User/PetFurniture';
import Bedbox from './Components/User/Bedbox';
import Modernwriting from './Components/User/Modernwriting';
    ...
    <div className="App">
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/pet-furniture" element={<PetFurniture />} />
          <Route path='/diningset' element={<DiningSet />} />          
          <Route path='/storage' element={<Storage />} />      
          <Route path='/studytable' element={<StudyTable />} />      
          <Route path='/office' element={<Office />} />      
          <Route path='/dressing' element={<Dressing />} />      
          <Route path='/bedbox' element={<Bedbox />} />      
          <Route path='/Modernwriting' element={<Modernwriting />} />      
          <Route path='/Egchair' element={<Egchair />} />      
