    ...
    <div className="container BodyHeader">
      ...
      <div>
        ...
        <div className="row ShopCategory">
          ...
          <div className="col-sm-6 col-md-4">
          <Link to="/diningset" className="imageContainer linkWithoutDecoration">
        ...
        <div className="row ShopCategory">
          ...
          <div className="col-sm-6 col-md-4">
            <Link to="/studytable" className="imageContainer linkWithoutDecoration">
          ...
          <div className="col-sm-6 col-md-4">
            <Link to="/dressing" className="imageContainer linkWithoutDecoration">
      ...
      <div>
        <div>
          <h3 className="BestSellerH3">Sink into Comfort!!</h3>
        </div>
        <div className="row BestSellCategory">
          <div className="col-sm-6 col-md-3">
            ...
            >
              ...
              <p className="BestSellP">Selective Choices, Starting ₹10710</p>
            </Link>
          </div>
          <div className="col-sm-6 col-md-3">
            <Link
            ...
            >
              ...
              <p className="BestSellP">Selective Choices, Starting ₹2799</p>
            </Link>
          </div>
          <div className="col-sm-6 col-md-3">
            <Link
            ...
            >
              ...
              <p className="BestSellP">Selective Choices, Starting ₹3799</p>
            </Link>
          </div>
          <div className="col-sm-6 col-md-3">
            <Link
            ...
            >
              ...
              <h4>Shoe Cabinets</h4>
              <p className="BestSellP">Selective Choices, Starting ₹3499</p>
            </Link>
          </div>
        </div>
      </div>
